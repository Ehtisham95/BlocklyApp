                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,int id) {
                                        ...
                                        // edit text
                                         ...
                                         final String SAVE_AS = String.valueOf(userInput.getText()) +".xml";
                                        mBlocklyActivityHelper.saveWorkspaceToAppDirSafely(SAVE_AS);
                                        Toast.makeText(getApplicationContext(), "Workspace saved as" + SAVE_AS, Toast.LENGTH_SHORT).show();
                                    }
                                })

...
public final class DefaultBlocks {
    ...
    /** Path to block definitions for blocks related to movements. */
    public static final String MOVEMENT_BLOCKS_PATH = "default/movement_blocks.json";
    /** Path to block definitions for blocks related to controls. */
    public static final String CONTROLS_BLOCKS_PATH = "default/controls_blocks.json";
    /** Path to block definitions for blocks related to loops. */
    public static final String LOOPS_BLOCKS_PATH = "default/loops_blocks.json";
    /** Path to block definitions for blocks related to appearance. */
    public static final String APPEARANCE_BLOCKS_PATH = "default/app_blocks.json";
    ...
    public static List<String> getAllBlockDefinitions() {
        if (ALL_BLOCK_DEFINITIONS == null) {
            ALL_BLOCK_DEFINITIONS = Collections.unmodifiableList(Arrays.asList(
                    MOVEMENT_BLOCKS_PATH,
                    CONTROLS_BLOCKS_PATH,
                    LOOPS_BLOCKS_PATH,
                    APPEARANCE_BLOCKS_PATH
            ));
        }
